...
function StockPredictionDescription({route, navigation}) {
    ...
    return (
        <SafeAreaView style={{alignContent: 'center', flex: 1, backgroundColor: '#21262f',}}>
            <Text style={{color: '#B9BBB6', fontSize: 18, padding: 7, paddingTop: 50,}}>
            ...
            <Text style={{textAlign: 'center', fontSize: 26, color: 'white', paddingBottom: 20,}}>{companyName} -
